...
import workWithMe.db.UserRatings.nullable

object UserStorages : IntIdTable() {
...
class UserStorage(id: EntityID<Int>) : IntEntity(id) {
    companion object : IntEntityClass<UserStorage>(UserStorages)
