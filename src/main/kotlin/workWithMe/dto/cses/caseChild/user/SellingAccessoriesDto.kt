...
@Serializable
data class SellingAccessoriesDto(
    val iD : Int? = null,
    ...
    val referrersOnUserStorage : UserStorageDto? = null,// ستون pointToSellingAccessories جدول UserStorageDto به این ستون اشاره دارد
    var referrersOnUserRating : UserRatingDto? = null,// ستون pointToSellingAccessories جدول UserRatingDto به این ستون اشاره دارد
